        ...
        <div className="row">
          <div className="col-sm-6 col-xs-12 order-md-1">
            <div className="image mb-4 mb-md-0">
              <img className="img-fluid rounded" src="assets/img/features/features-img2.jpg" alt="features-img1.jpg" />
            </div>
          </div>
          ...
          <div className="col-sm-6 col-xs-12">
            <div className="">
              ...
              <p className="text-dark font-size-15 mb-4">A ONG nasceu em 2015 e hoje conta com vários voluntários engajados. Desde o início, buscamos mapear as necessidades da comunidade e trabalhar diretamente em parceria com moradores locais. Hoje, trabalhamos em colaboração com a Creche Sorriso, aonde ajudamos a construir o espaço, melhorar a estrutura pedagógica, alimentar 60 crianças diariamente, e capacitar as famílias.</p>
              ...
              <ul className="list-unstyled mb-5">
                ...
                <li className="d-flex align-items-baseline text-muted mb-2">
                  <i className="fa fa-check mr-2" aria-hidden="true"></i>
                  Promover apoio e melhoria na educação das crianças
                </li>
              </ul>
            </div>
          </div>
        </div>
        <Link to="doar" className="btn btn-danger shadow-sm text-uppercase mt-4">
          <i className="fa fa-money mr-2" aria-hidden="true"></i>DOAR
        </Link>
      </div>
      </section>
